...
const StoriesBar = () => {
  ...
  return (
    ...
    '>
        ...
        {/* Add story model */}
        {showModel && <StoriesModel setShowModel={setShowModel} fetchStories={fetchStories}></StoriesModel>}
        {/* View story model */}
        {viewStory && <StoryViewed viewStory={viewStory} setViewStory={setViewStory}></StoryViewed>}
