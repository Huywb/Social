  ...
  return (
    ...
    '>
        ...
        <div className='flex gap-4 pb-5'>
            {/*Add story card */}
            <div className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer
            ...
            {/*Story card */}
            {
                stories.map((story,index)=>(
                    <div index={index} className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40
                    ...
                    to-purple-600 hover:from-indigo-700 hover:to-pink-800 active:scale-95`}>
                        ...
                        <p className='absolute top-18 left-3 text-white/60 text-sm truncate 
                        max-w-24'>{story.content}</p>
                                ...
                                <div className='absolute inset-0 z-1 rounded-lg bg-black overflow-hidden'>
                                    {
                                        ...
                                        hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'></img>:
                                        <video src={story.media_url} className='h-full w-full object-cover
                                        hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'></video>
                                    }
                                </div>
                            )
                        }
