        ...
        <div className='max-w-2xl sm:py-6 mx-auto'>
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    {/*Cover photo */}
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className='block text-sm font-medium text-slate-700
                        mb-1'>
                            Cover photo
                            ...
                            <div className='group/cover relative'>
                                ...
                                alt="" className=' w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        <button onClick={()=>setShowEdit(false)} className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700
