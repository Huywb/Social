...
const Sidebar = ({sidebarOpen,setSidebarOpen}) => {
  ...
  return (
    <div className={`w-60 xl:w-72 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 left-0 z-20 
    ...
    `}>
      <div className='w-full'>
        ...
        <MenuItem setSidebarOpen={setSidebarOpen}></MenuItem>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
        ...
        <LogOut onClick={signOut} className='w-4.5 text-gray-400 hover:text-gray-700 transition cursor-pointer'></LogOut>
      </div>
    </div>
  )
}
